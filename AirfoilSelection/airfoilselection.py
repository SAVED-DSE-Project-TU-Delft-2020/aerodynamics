...
final_file = open("finalresults.txt","w")
final_file_lines_A = ["FINAL AIRFOIL SELECTION RESULTS","\n","\n","Concept A: NACA"+airfoil_A_WSM,"\n", "Cl/Cd @ Cldes = "+str(round(float(airfoil_results_AD[index_A][1]),1)),"\n", "Cmac = "+str(round(float(airfoil_results_AD[index_A][2]),4)),"\n","Alpha cruise = "+str(round(float(airfoil_results_AD[index_A][3]),3)),"\n", "Cl_max @ Re_transition = "+str(round(float(airfoil_results_AD[index_A][4]),1)),"\n","Alpha stall @ Re_transition = "+str(round(float(airfoil_results_AD[index_A][5]),1))]
...
final_file_lines_D = ["\n","\n","Concept D: NACA"+airfoil_D_WSM,"\n", "Cl/Cd @ Cldes = "+str(round(float(airfoil_results_AD[index_D][1]),1)),"\n", "Cmac = "+str(round(float(airfoil_results_AD[index_D][2]),4)),"\n","Alpha cruise = "+str(round(float(airfoil_results_AD[index_D][3]),3)),"\n", "Cl_max @ Re_transition = "+str(round(float(airfoil_results_AD[index_D][4]),1)),"\n","Alpha stall @ Re_transition = "+str(round(float(airfoil_results_AD[index_D][5]),1))]
...
final_file_lines_C = ["\n","\n","Concept C: "+airfoil_C_WSM,"\n", "Cl/Cd @ Cldes = "+str(round(float(airfoil_results_C[index_C][1]),1)),"\n", "Cmac = "+str(round(float(airfoil_results_C[index_C][2]),4)),"\n","Alpha cruise = "+str(round(float(airfoil_results_C[index_C][3]),3)),"\n", "Cl_max @ Re_transition = "+str(round(float(airfoil_results_C[index_C][4]),1)),"\n","Alpha stall @ Re_transition = "+str(round(float(airfoil_results_C[index_C][5]),1))]
